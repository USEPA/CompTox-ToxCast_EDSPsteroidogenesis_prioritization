...
#This script generates figure 3 and supp data 1#
...
pdf("./figures/Figure3_scatterplot_mMdBoxplots.pdf", width = 12, height = 10)
p
dev.off()

png("./figures/Figure3_scatterplot_mMdBoxplots.png", width = 12, height = 10, units = "in", res = 300)
p
dev.off()

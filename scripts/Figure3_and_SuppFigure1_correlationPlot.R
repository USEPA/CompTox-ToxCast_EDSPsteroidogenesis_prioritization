...
#This script generates figure 3 (correlation plots) and supplemental figure 1
...
pdf("./figures/Figure3_merged_correlation_plot.pdf", width = 8, height = 8)
p
dev.off()

png("./figures/Figure3_merged_correlation_plot.png", width = 8, height = 8, units = "in", res = 300)
p
dev.off()

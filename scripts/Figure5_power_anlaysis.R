...
#This script generates figure 5 and also output the power analysis as a txt file#
...
pdf("./figures/Figure5_powerAnalysis.pdf", width = 14, height = 8)
p
dev.off()

png("./figures/Figure5_powerAnalysis.png", width = 14, height = 8, units = "in", res = 300)
p
dev.off()
